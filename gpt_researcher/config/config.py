...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.llm_provider = os.getenv("LLM_PROVIDER", "litellm")
        ...
        self.llm_model = os.getenv("DEFAULT_LLM_MODEL", "azure/gpt_4o_chat")
        self.fast_llm_model = os.getenv("FAST_LLM_MODEL", "azure/gpt_4o_chat")
        self.smart_llm_model = os.getenv("SMART_LLM_MODEL", "azure/gpt_4o_chat")
